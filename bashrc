...
# TODO: This needs updated to work properly on non-Linux systems, namely OSX and BSD
# The aliases below do not work on systems that don't use the GNU versions of ls and grep.
